...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:1234@localhost/ghostprotocols?sslmode=disable", "PostgreSQL DSN")
	...
	flag.IntVar(&cfg.limiter.burst, "limiter-burst", 15, "Rate limiter maximum burst")
